# Training Guide - Agent McQueen

Autonomous racing agent trained with **Residual Policy Learning** for overtaking opponents.

> For setup instructions, see [SETUP.md](SETUP.md). For ROS2 integration details, see [ARCHITECTURE.md](ARCHITECTURE.md).
...
```
training/
├── README.md                    # This file (also in ../docs/TRAINING.md)
...
- [Setup Guide](SETUP.md) - How to run the agents in simulators
- [Architecture](ARCHITECTURE.md) - ROS2 integration and topics
